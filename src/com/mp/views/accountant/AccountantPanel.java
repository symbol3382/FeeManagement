...
import com.mp.AddStudent;
import com.mp.DueFee;
import com.mp.EditStudent;
import com.mp.FeeReport;
import com.mp.ViewStudent;
...
public class AccountantPanel extends JPanel{
	...
	public AccountantPanel(User user) {
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(scrollPaneUserList, GroupLayout.DEFAULT_SIZE, 852, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(textField, GroupLayout.PREFERRED_SIZE, 414, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(btnSearchByRegistration, GroupLayout.PREFERRED_SIZE, 173, GroupLayout.PREFERRED_SIZE)
							.addGap(137))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(listTitlePanel, GroupLayout.PREFERRED_SIZE, 851, GroupLayout.PREFERRED_SIZE)
							.addContainerGap(11, Short.MAX_VALUE))
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(lblAccountant, GroupLayout.PREFERRED_SIZE, 435, GroupLayout.PREFERRED_SIZE)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblAccountant, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
					.addGap(21)
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
						.addComponent(btnSearchByRegistration, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(textField, GroupLayout.DEFAULT_SIZE, 29, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED, 35, Short.MAX_VALUE)
					.addComponent(listTitlePanel, GroupLayout.PREFERRED_SIZE, 30, GroupLayout.PREFERRED_SIZE)
					.addGap(8)
		...
		gl_listTitlePanel.setHorizontalGroup(
			gl_listTitlePanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_listTitlePanel.createSequentialGroup()
					.addComponent(lblRegNo, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblName, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblMobileNumber, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblFeetype, GroupLayout.PREFERRED_SIZE, 111, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblFee, GroupLayout.PREFERRED_SIZE, 97, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblPaid, GroupLayout.PREFERRED_SIZE, 97, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblDue, GroupLayout.PREFERRED_SIZE, 97, GroupLayout.PREFERRED_SIZE)
					.addComponent(lblPay, GroupLayout.PREFERRED_SIZE, 79, GroupLayout.PREFERRED_SIZE))
		);
		gl_listTitlePanel.setVerticalGroup(
			gl_listTitlePanel.createParallelGroup(Alignment.LEADING)
		...
		for( UserFee userFee: userFees) {
			...
			resultRow.btnPay.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					if(due == 0) {
						JOptionPane.showMessageDialog(panel, "There is no amount to pay on this fees for student : " + userFee.name, "No Due", JOptionPane.WARNING_MESSAGE);
					} else {
						int paying = Integer.parseInt(JOptionPane.showInputDialog(panel, "Enter Amount", "Fee Pay - " + fee, JOptionPane.QUESTION_MESSAGE));
						if(paying > due) {
							JOptionPane.showMessageDialog(panel, "Please Enter pay by student on less or equal than : " + due, "Amount Exceed", JOptionPane.WARNING_MESSAGE);
						} else {
							// Pay fees
							if(DatabaseConfig.payFees(reg_no, fee_type, course, fee, paid, due, paying) == 1) {
								JOptionPane.showMessageDialog(panel, "Done" + due, "Done", JOptionPane.PLAIN_MESSAGE);
